...
const (
	...
	OrderService_GetOrderList_FullMethodName = "/pb.OrderService/GetOrderList"
)
...
type OrderServiceClient interface {
	...
	GetOrderList(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error)
}
...
func (c *orderServiceClient) GetOrderList(ctx context.Context, in *Blank, opts ...grpc.CallOption) (*OrderList, error) {
	out := new(OrderList)
...
type OrderServiceServer interface {
	...
	GetOrderList(context.Context, *Blank) (*OrderList, error)
...
func (UnimplementedOrderServiceServer) GetOrderList(context.Context, *Blank) (*OrderList, error) {
...
func _OrderService_GetOrderList_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).GetOrderList(ctx, req.(*Blank))
	}
	return interceptor(ctx, in, info, handler)
}
